package br.gov.pr.idr.legacy.entity.changepassword.impl;
...
import br.gov.pr.idr.legacy.entity.email.dto.EmailDto;
import br.gov.pr.idr.legacy.entity.changepassword.ChangePassword;
import br.gov.pr.idr.legacy.entity.email.Email;
import br.gov.pr.idr.legacy.entity.user.User;
import br.gov.pr.idr.legacy.entity.changepassword.ChangePasswordRepository;
import br.gov.pr.idr.legacy.entity.changepassword.ChangePasswordService;
import br.gov.pr.idr.legacy.entity.email.EmailService;
