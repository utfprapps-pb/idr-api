package br.gov.pr.idr.legacy.entity.vegetabledisease.impl;


import br.gov.pr.idr.legacy.entity.crud.impl.CrudServiceImpl;
import br.gov.pr.idr.legacy.entity.vegetabledisease.VegetableDisease;
import br.gov.pr.idr.legacy.entity.vegetabledisease.VegetableDiseaseRepository;
import br.gov.pr.idr.legacy.entity.vegetabledisease.VegetableDiseaseService;
