    ...
    public SecurityFilterChain filterChain(HttpSecurity http) {
        ...
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.POST, "/v1/email/send-recuperation-code").permitAll()
                        .requestMatchers(HttpMethod.POST, "/v1/email/validate-recuperation-code").permitAll()
                        .requestMatchers(HttpMethod.POST, "/v1/email/reset-password").permitAll()
                        .requestMatchers("/error/**", "/v3/**", "/swagger-ui/**", "/webjars/**").permitAll()
                        .requestMatchers(HttpMethod.GET, "/v1/users/me").authenticated()
                        .requestMatchers(HttpMethod.GET, "/v1/users/search").authenticated()
